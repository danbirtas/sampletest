...
module.exports = require('./MapStore2/build/buildConfig')(
    {
        'DEAP': path.join(__dirname, "js", "app"),
        'DEAP-embedded': path.join(__dirname, "js", "embedded"),
        'DEAP-api': path.join(__dirname, "MapStore2", "web", "client", "product", "api"),
